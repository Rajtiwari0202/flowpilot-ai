...
* **Contrast Ratios**: Body copy (`text-slate-900`/`dark:text-slate-100` and `text-slate-650`/`dark:text-slate-400` on `#f8fafc`/`dark:bg-slate-950`) exceeds the WCAG AA minimum contrast ratio (4.5:1).
