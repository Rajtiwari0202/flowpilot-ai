...
export function Navbar() {
  return (
    <nav className="sticky top-0 z-50 w-full border-b border-slate-200 dark:border-slate-800 bg-white/95 dark:bg-slate-950/95 backdrop-blur-sm select-none" aria-label="Main Navigation">
      <div className="mx-auto max-w-7xl flex h-16 items-center justify-between px-6 lg:px-8">
        ...
        <Link href="/" className="flex items-center gap-2.5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue-600 rounded-md">
          ...
          <span className="text-sm font-bold text-slate-900 dark:text-white tracking-tight">FlowPilot AI</span>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-8 text-xs font-semibold text-slate-500 dark:text-slate-400">
          ...
          <span className="text-slate-400 dark:text-slate-500 cursor-not-allowed select-none">Pricing <span className="text-[10px] bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 rounded px-1.5 py-0.5 ml-1">Soon</span></span>
        </div>
