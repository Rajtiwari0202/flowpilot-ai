...
export const metadata: Metadata = {
  title: "ACE Terms of Service",
  description: "Terms and conditions of service for using ACE.",
};
    ...
    <main className="min-h-screen bg-slate-50 dark:bg-black text-slate-900 dark:text-zinc-300 py-12 px-6 sm:px-12 lg:px-24">
      <div className="max-w-3xl mx-auto bg-white dark:bg-[#0A0A0A] border border-slate-200 dark:border-[#171717] rounded-xl p-8 shadow-sm">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold mt-4 text-slate-900 dark:text-white">ACE Terms of Service</h1>
        ...
        <div className="space-y-6 text-sm leading-6 text-slate-700 dark:text-zinc-300">
          <section>
            <h2 className="text-lg font-bold text-slate-900 dark:text-white mb-2">Acceptance of Terms</h2>
            <p>
              By creating an account or using ACE, you agree to comply with and be bound by these Terms of Service. If you do not agree to these terms, please do not use the application.
            </p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-slate-900 dark:text-white mb-2">User Responsibilities</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 dark:text-white mb-2">Google Integration Usage</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 dark:text-white mb-2">Account Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 dark:text-white mb-2">Limitation of Liability</h2>
            <p>
              ACE shall not be liable for any direct, indirect, incidental, or consequential damages resulting from the use or inability to use the service, including data loss or automated actions.
            </p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-slate-900 dark:text-white mb-2">Service Availability</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 dark:text-white mb-2">Contact Information</h2>
            <p>
