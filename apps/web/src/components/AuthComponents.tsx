      ...
      <div className="w-full max-w-md">
        ...
        <div className="panel p-6">
          ...
          <form className="space-y-4" onSubmit={submit}>
            {mode === "signup" && <Field label="Full name" name="name" placeholder="Alex Johnson" required autoComplete="name" />}
            <Field label="Work email" name="email" placeholder="alex@company.com" required type="email" autoComplete="email" />
            <Field label="Password" name="password" placeholder="Minimum 8 characters" required type="password" autoComplete={mode === "signup" ? "new-password" : "current-password"} />
